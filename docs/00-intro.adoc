...
https://isi-nlp.github.io/rtg-xt[Reader-Translator-Generator (RTG)] is a Neural Machine Translation toolkit based on pytorch.
...
# use https://github.com/isi-nlp/rtg.git if you have access to rtg.git
